 ...
 */
public class InformacionTotalCover extends CoverPage {

    public final static String page = (String) PagesList.getRootUrls().get(PagesList.pages.INFORMACIONTOTAL );
    public final String regex = new String("\\/(\\d+-){3}\\w+\\/[\\w\\d-]+\\/");

    public InformacionTotalCover(HtmlProcess htmlProcess) throws IOException {
