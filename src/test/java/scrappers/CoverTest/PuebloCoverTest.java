 ...
 */
public class PuebloCoverTest extends StubService implements CommonCoverTest {

    public String url = PuebloCover.page;
    ...
    public void setup() throws IOException {
        ...
        HtmlProcess htmlProcessStub = this.getAndSetStub("/stubCover/stubPuebloCover.html", this.url);
        cover = new PuebloCover(htmlProcessStub);
