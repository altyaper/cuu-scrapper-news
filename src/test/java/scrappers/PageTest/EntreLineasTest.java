...
public class EntreLineasTest implements CommonTest {
    ...
    public void itShouldGetTheContent() {
        assertEquals("Noticias de Chihuahua.- Tras el anuncio de la entrada de Über a Chihuahua y a Ciudad Juárez, el director de Transporte de Gobierno del Estado, Gustavo Morales González, aseguró que hasta el momento la empresa no se ha acercado directamente a la dependencia para plantear esta posibilidad, por lo que su actuar se encontraría fuera de la ley. Morales González señaló que, de acuerdo a la legislación en la materia, la empresa requeriría de una concesión para poder operar en la entidad, sin embargo, en ningún momento ha enterado a Gobierno del Estado sobre su incursión al mercado de transporte. En este tenor, el funcionario detalló que más allá de estar en contra de que la empresa ingrese en Chihuahua, se requiere que ésta se presente ante la Dirección de Transporte y, dado que no lo ha hecho, podrían ser sujeta a sanciones. Cabe señalar que Über publicó en su página de internet el siguiente comunicado: “Estamos muy felices de anunciar la llegada de Über a Chihuahua y Ciudad Juárez este viernes 24 de junio, siguiendo con nuestro compromiso de ofrecer una opción de movilidad segura y eficiente”, lo que alertó de inmediato a los taxistas de la ciudad que ya han manifestado posibles movilizaciones.", article.getContent());
    }
